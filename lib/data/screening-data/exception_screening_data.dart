class ExceptionData {
  ...
  static List<ExceptionData> getData() {
    ...
    //4 nrs before&after >8
    exceptionmockup.add(ExceptionData(
        titleLabel: 'ดูเหมือนว่าค่าความเจ็บปวดของคุณมากเกินไป',
        descriptionLabel:
            'ค่าความเจ็บปวดของคุณมากเกินไป ทางเราไม่แนะนำให้ท่านบริหารร่างกายต่อ ควรหยุดพักและพบแพทย์เพื่อได้รับการรักษาที่ถูกต้อง'));
