...
////////////////////////////////////// NOTE ////////////////////////////////////////
    ...
    group('Test screening question (Part 2)', () {
      ...
      test('get models by list of part', () {
        ...
        var result = ScreeningQuestionPartTwoService
            .getScreeningPartTwoModelByListOfParts(parts);
    ...
    group('Test screening question (Part 3)', () {
      ...
      test('get all part title', () {
        ...
        expect(result,
            equals(postures.map((part) => part.title).toSet().toList()));
      });
      ...
      test('get questions by page', () {
        ...
        expect(
            result.every((question) => question.questionPage == questionPage),
            isTrue);
      });
      ...
      test('get model by part', () {
        ...
        expect(
            ...
            isTrue);
        expect(
            results.postures.every((posture) => posture.title == selectedPart),
            isTrue);
      });
    });
  });
